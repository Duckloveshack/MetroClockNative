...
type DialScreenAttributes = {
    number?: string
}

function DialScreenInternal({
    number = ""
}: DialScreenAttributes): React.JSX.Element {
    ...
    const [ dialedNumber, setDialedNumber ] = useState<string>(number);
    //@ts-ignore
                        ...
                        >
                            ...
                            <View style={{
                                ...
                                <DialSaveButton
                                    ...
                                    onPress={() => {
                                        if (dialedNumber.length !== 0) {
                                            NativeCallContact.createModifyContact(dialedNumber);
                                        }
                                    }}
                                />
                            </View>
...
export default DialScreenInternal;